...
def main():
    rows = [
        ...
        {
            "artifact_key": "management_layer_artifact_lifecycle_policy",
            ...
            "management_layer_role": "artifact_lifecycle_and_repo_discipline_policy",
            "tracked_in_repo_flag": 1,
            "local_only_output_flag": 0,
            "qa_coverage_flag": 1,
            "qa_script_path": "scripts/qa/validate_management_layer_artifact_lifecycle_policy.py",
            "source_dependency_class": "governance_metadata",
            "methodology_boundary_note": COMMON_BOUNDARY_NOTE,
        },
        {
            "artifact_key": "management_layer_governance_manifest",
            ...
            "management_layer_role": "governance_stack_scope_and_control_manifest",
            "tracked_in_repo_flag": 1,
            "local_only_output_flag": 0,
            "qa_coverage_flag": 1,
            "qa_script_path": "scripts/qa/validate_management_layer_governance_manifest.py",
            "source_dependency_class": "governance_metadata",
            "methodology_boundary_note": COMMON_BOUNDARY_NOTE,
        },
        {
            "artifact_key": "management_layer_reviewer_quickstart",
            ...
            "management_layer_role": "reviewer_onboarding_and_fast_start_guide",
            "tracked_in_repo_flag": 1,
            "local_only_output_flag": 0,
            "qa_coverage_flag": 1,
            "qa_script_path": "scripts/qa/validate_management_layer_reviewer_quickstart.py",
            "source_dependency_class": "governance_metadata",
            "methodology_boundary_note": COMMON_BOUNDARY_NOTE,
        },
        {
            "artifact_key": "management_layer_review_log_template",
            ...
            "management_layer_role": "review_execution_evidence_and_handoff_log_template",
            "tracked_in_repo_flag": 1,
            "local_only_output_flag": 0,
            "qa_coverage_flag": 1,
            "qa_script_path": "scripts/qa/validate_management_layer_review_log_template.py",
            "source_dependency_class": "governance_metadata",
            "methodology_boundary_note": COMMON_BOUNDARY_NOTE,
        },
    ]
