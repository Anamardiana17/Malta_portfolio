...
- Use this section inside the main README under the Operating Model / Management Layer heading.
- Pair it with the executive readout markdown and quick-scan CSV for deeper review.

## Core supporting files
- `data_processed/operating_model/malta_operating_model_executive_readout.md`
- `data_processed/operating_model/executive_quick_scan_strip.csv`
- `data_processed/operating_model/manager_action_queue_modeled_enriched.csv`
- `data_processed/operating_model/therapist_coaching_summary_modeled.csv`
- `data_processed/operating_model/outlet_staffing_management_view.csv`